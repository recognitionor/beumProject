...
sealed interface CommunityAction {
    data class OnCategoryGroupSelected(val categoryGroupName: String, val isDevil: Boolean) :
        CommunityAction
    ...
    data class PickComment(val targetUserId: String, val boardId: String) : CommunityAction
